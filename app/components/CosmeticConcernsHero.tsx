...
const concerns = [
  { label: "Fine Lines", value: 72 },
  { label: "Dark Spots", value: 58 },
  { label: "Texture", value: 64 },
  { label: "Redness", value: 33 },
];

export default function CosmeticConcernsHero() {
  return (
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <p className="mb-4 text-xs tracking-[0.35em] text-gray-500">
            A.I. ANALYSIS / COSMETIC CONCERNS
          </p>
          ...
          <p className="mt-5 max-w-xl text-sm leading-7 text-gray-500">
            Review the areas that may benefit from additional attention and
        ...
        <div className="grid grid-cols-1 border-l border-t border-gray-200 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-4 max-w-md text-sm leading-7 text-gray-500">
              Your analysis suggests fine lines are the highest-priority
              cosmetic concern, followed by texture and dark spots.
            </p>
            ...
            <div className="relative z-10">
              ...
              <div className="mt-10 space-y-10">
                <Recommendation
                  ...
                  text="Use broad-spectrum SPF consistently to help reduce visible sun-related skin changes."
                />

                <Recommendation
                  number="02"
                  title="Skin Renewal"
                  text="Support healthy skin turnover with a routine focused on smoother and more even-looking skin."
                />

                <Recommendation
                  number="03"
                  title="Barrier Support"
                  text="Maintain hydration and protect the skin barrier to help improve the appearance of fine lines."
                />
              </div>
            </div>
          </motion.div>
